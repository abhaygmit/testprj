...
class Template_model extends CI_Model 
{
	...
	{
		$query=$this->db->query("SELECT * FROM op_procedures 
	...
	{
		$query=$this->db->query("SELECT op_procedures.*, op_classes.id as classID, op_classes.time_attribute, op_classes.class_attribute, op_classes.color_code as colorCode FROM op_procedures 
								 LEFT JOIN op_classes ON op_classes.id = op_procedures.class_id
