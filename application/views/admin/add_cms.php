...
<div class="rightColm">
            <div class="result_opt">
                <div class="left"><h2>Add Page</h2></div>
			...
			<form action="cms/add_page" method="POST" class="" id="cms_form" name="cms_form" onsubmit="return validateCmsForm()">
				<div  >
				...
				<!-- <div class="adminFldRw posit_err">
	                ...
	                <div class="adminInptTxt ">
						...
						<option value="<?php echo $parent_page->id;?>"><?php echo $parent_page->title; ?></option>
						<?php }?>
						</select>
					</div>
                </div> -->
            	...
            	<div class="adminFldRw posit_err">
	                ...
	                <div class="adminInptTxt ">
						<input type="text" name="title" id="title" maxlength="40" value="<?php echo $_POST['title'];?>" onblur="return clearDiv();"/><span id="cms_title_err" class="error"></span>
					</div>
                </div>
				...
				<div class="adminFldRw posit_err">
	                ...
	                <div class="adminInptTxt ">
						<input type="text" name="meta_keyword" id="meta_keyword" maxlength="90" value="<?php echo $_POST['meta_keyword'];?>" /><span id="meta_keyword_err" class="error"></span>
					</div>
                </div>
				...
				<div class="adminFldRw posit_err">
	                ...
	                <div class="adminInptTxt ">
						<input type="text" name="meta_description" id="meta_description" maxlength="140"  value="<?php echo $_POST['meta_description'];?>"/><span id="meta_description_err" class="error"></span>
					</div>
                </div>
				...
				<div class="adminFldRw posit_err">
	                ...
	                <div class="adminInptTxt ">
						<input type="text" name="sort_order" id="sort_order" maxlength="3" value="<?php echo $_POST['sort_order'];?>" /><span id="sort_order_err" class="error"></span>
					</div>
                </div>
				 ...
				 <div class="adminFldRw_mngHM posit_err">
				   ...
				   <?php 
					...
					echo $this->ckeditor->editor("green_bar",$_POST['green_bar']);
					?>
                ...
                <div class="adminFldRw posit_err" style="width:100%">
					...
					echo $this->ckeditor->editor("description",$_POST['description']);
					?>
