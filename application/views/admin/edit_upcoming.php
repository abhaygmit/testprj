	                ...
	                <div class="adminInptTxt">
						<select name="category_name" id="category_name">
							...
							<?php foreach($categorydata as $cat){?>
								<option value="<?php echo $cat['id'];?>" <?php echo ($cat['id']==$categoryToEdit[0]->merchant_account_type_id?'selected':'');?>><?php echo $cat['account_type'];?></option>
							<?php }?>	
						</select>
					</div>
                </div>
                ...
                <div class="adminFldRw posit_err">
	                ...
	                <div class="adminInptTxt">
						<select name="status" id="status">
							...
							<option value="2" <?php echo ($categoryToEdit[0]->status=='2'?'selected':'');?>>Upcoming</option>
