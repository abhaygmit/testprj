        ...
        <div class="inconwrap">
            ...
            <table cellspacing="0" cellpadding="0" border="1" width="100%">
                ...
                <tr>
                    ...
                    <td><a href="<?php echo base_url().'home/edittreatment_type/'.toPublicId($v->id) ?>">Edit</a> / <a href="<?php echo base_url().'home/deletetreatment_type/'.toPublicId($v->id) ?>">Delete</a></td>
                </tr>
                <?php
                   $i++; }
                } ?>
