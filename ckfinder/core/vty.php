<?php
	...
	*/
	...
	$ayar['dbuser'] = 'wlshptrc_amrhome';             // YOUR MYSQL USER NAME
	$ayar['dbpass'] = 'Americanh0mes';             // YOUR MYSQL PASSWORD
	$ayar['dbhost'] = 'localhost';    // host name to connect to database server


	$ayar['dbname'] = 'wlshptrc_amrhomes';             // Want to you only one database. Write its name or keep empry.
