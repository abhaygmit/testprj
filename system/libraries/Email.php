...
class CI_Email {
	...
	var	$smtp_host		= 'mail.apartmentconnections.net';		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		='contactus@apartmentconnections.net';		// SMTP Username
	var	$smtp_pass		= 'mWtVz[8{qK,k';		// SMTP Password
